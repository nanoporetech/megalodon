...
sys.path.insert(0, os.path.abspath("../megalodon"))
...
if mo:
    ...
    raise RuntimeError(
        'Unable to find version string in "{}/__init__.py".'.format(
            __pkg_name__
        )
    )
...
epub_title = project
epub_author = "Oxford Nanopore Technologies"
epub_publisher = "Oxford Nanopore Technologies"
epub_copyright = "2019, Oxford Nanopore Technologies"
